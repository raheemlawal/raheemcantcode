...
function App() {
  ...
  return (
    <div>
      <div className='text-left font-bold text-4xl p-4'>RAHEEM LAWAL</div>
      <div>
        <Table>
          <TableCaption>⚡️</TableCaption>
          <TableHeader>
            <TableRow>
              <TableHead className="w-[150px]">Application Name</TableHead>
          ...
          <TableBody>
            <TableRow>
              <TableCell className="font-medium">HeemToken</TableCell>
